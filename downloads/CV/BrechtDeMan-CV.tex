...
\runsubsection{\href{https://www.koncon.nl/en/}{Royal Conservatory of The Hague}}
\hspace{-0.1cm}\descript{| Guest Lecturer}
\location{Sep 2019 – present | The Hague, Netherlands}
\vspace{\topsep} % Hacky fix for awkward extra vertical space

\runsubsection{\href{http://www.bcu.ac.uk}{Birmingham City University}}
\hspace{-0.1cm}\descript{| Research Fellow}
\location{Mar 2018 – Nov 2018 | Birmingham, UK}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
%\begin{tightitemize}
...
\location{Sep 2013 – present | JavaScript, Python, HTML/CSS}
...
\location{Dec 2013 – May 2014 | C++, Python}
