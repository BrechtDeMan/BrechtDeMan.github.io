...
\namesection{Brecht}{De Man}{ % Your name
...
C++ \textbullet{} C \textbullet{} Python \textbullet{} Java \textbullet{}  MATLAB \textbullet{} 
 HTML \textbullet{} Shell \textbullet{} Assembly \textbullet{}  LaTeX \\
...
\item Vice Chair of the Student Delegate Assembly, representing over 4000 student members
...
\location{Sep 2012 – present | London, UK}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
...
\item Designed and implemented \href{http://brechtdeman.com/downloads/aes53.pdf}{adaptive distortion plugin}
\end{tightitemize}
\sectionspace % Some whitespace after the section
...
\item Live sound engineer for various festivals in Belgium, certified by government
